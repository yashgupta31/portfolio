...
const Skills = () => {
    ...
    return (
        <Box minH={'95vh'} bg={isDark?colors.dark.third: colors.light.third} pt={'1.6rem'} pb={'1rem'} display={'flex'} flexDirection={'column'} alignItems={'center'} textAlign={'center'}>
            ...
            <Text fontSize={isLargerThan500 ? '2.6rem' : '2.2rem'} color={isDark? 'white': '#434242'} fontWeight={'450'} >My <Text as={'span'} color={colors.primary}>Technical</Text> Skills</Text>

            <Box w={isLargerThan500?'77%': '90%'} display={'flex'} flexWrap={'wrap'} justifyContent={'center'} mt={'4rem'} gap={10} >
                {/* html */}
                <Box bg={'white'} className='skill-container' w={'6.5rem'} h={'7.5rem'} position={'relative'} display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius={'8px'} transition={'0.5s'} _hover={{ boxShadow: 'black 0px 3px 8px;', cursor: 'pointer', bg: '#F87C58' }}>
                ...
                {/* css */}
                <Box bg={'white'} className='skill-container' w={'6.5rem'} h={'7.5rem'} position={'relative'}  display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius={'8px'} transition={'0.5s'} _hover={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', cursor: 'pointer', bg: '#F87C58' }}>
